...
import { DestinationRatingWithDestination } from '../../src/types/objects/destinationRating';
...
describe('TensorFlow Service', () => {
    ...
    it('determineNewDestinations should peform the tensor flow estimated and return results', async () => {
        const result = await tensorFlowService.determineNewDestinations(destinationsWithoutRating as unknown as Destination[], destinationsWithRating as unknown as DestinationRatingWithDestination[])
